...
| **El servicio de dictado del navegador** (Google en Chrome, Apple en Safari) | El audio, cuando se usa dictar o grabar. **No pasa por Ombúa**: va del navegador a ese servicio y vuelve como texto. Esto ya está bien explicado en el documento. |
